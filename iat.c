...
void iat_display_func(ui_mode_t mode, u8 mode_changed);
u8 iat_config_func(ui_mode_t mode, ui_config_event_t event);
...
#define IAT_PEAK_AGE        4*5 /* 5 seconds */
...
void iat_init(adc_context_t *adc_context)
{
    ...
    register_display_mode(MODE_IAT, iat_display_func, iat_config_func);   
    register_display_mode(MODE_IAT_PEAK, iat_display_func, iat_config_func);   
